...
function configLink(page, link) {
  return 'svg-btn ' + link+'-btn' + ((page===link) ? ' active' : '');
}


export default function HeaderMobile({ page, setPage }) {
  return (
    <>
      <header>
      ...
      <nav id='mobile-nav'>
        <div className='wrapper'>
          <button 
            className={configLink(page, 'home')}
          ...
          <button 
            className={configLink(page, 'toons')}
            onClick={() => setPage('toons')}
          >
          ...
          <button 
            className={configLink(page, 'combos')}
