    ...
    <>
      <main>
        <div className={`wrapper ${styles.recommendationsWrap}`}>
          <div className={`${styles.tab} ${tab==="toons" ? styles.displayed : ""} ${styles.toonsTab}`}>
            <ToonsCard />
          </div>
          <div className={`${styles.tab} ${tab==="combos" ? styles.displayed : ""}`}>
            <CombosComponent />
          </div>
          <div className={`${styles.tab} ${tab==="cog" ? styles.displayed : ""} ${styles.cogTab}`}>
            <CogCard />
          </div>
        </div>
