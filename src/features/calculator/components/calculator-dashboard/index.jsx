...
function CalculatorMobileNav({ tab, setTab }) {
  const tabs = ["gags", "cogs"];
  return (
    <nav className={styles.calculatorNav}>
      <div className={`wrapper ${styles.calculatorNavWrapper}`}>
        {
          tabs.map((linkText, i) => {
            return (
              <button 
...
export default function CalculatorDashboard() {
  const [tab, setTab] = useState("gags");
  ...
  return (
    <>
      <main>
        ...
        <CalculatorMobileNav tab={tab} setTab={setTab} />
      </main>
